...
@DisplayName("Tests to check creation of new Ticket of general type")
public class CreateNewGeneralTicketTest extends BaseChromeConfiguration {
    ...
    @Test
    @DisplayName("Create new general Ticket")
    public void GeneralTicketCreation() throws SQLException {
        ...
        ticket.put(newTicketType, "General");
        ...
        ticket.put(newTicketCompany, "Sergii C1");
        ticket.put(newTicketContact, "Adam Savage");
        ...
        //create new general ticket using fluent pattern
        ticketsPage
                ...
                .setTicketCompany(ticket.get(newTicketCompany))
                .setTicketContact(ticket.get(newTicketContact))
